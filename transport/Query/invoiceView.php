...
<?php
  ...
  {
    $result=mysql_query("select * from tripdetails where invoice_no LIKE '$a'");
...
<tr><td>Contact:</td><td><?php echo $h1; ?></td></tr>
 ...
 <center> <form> <input type="submit" name="submit" value="print" onclick="javascript:printDiv('printablediv')"></form></center>
</body>
</html>
