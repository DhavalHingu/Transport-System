 ...
 <div id="div_print">
  <div id="page-wrap">
    ...
    <div id="identity">
            ...
            <label id="address">
<?php echo $h; echo "<br>";echo $g; ?></label>
    ...
    <div id="customer">
            ...
            <table id="meta">
                ...
                <tr>
                    <td class="meta-head">Client Contact</td>
                    <td><div class="due"><textarea></textarea></div></td>
                </tr>
    ...
    <table id="items">
      ...
      <tr class="item-row">
          <td><label class="cost"><?php echo $r; echo $s; echo $t; echo $u; ?></label></td>
