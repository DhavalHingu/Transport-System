  ...
  <div class="container">
      ...
      <div class="page-header">
        ...
        <h1>Trip Details</h1>
          ...
          <input type="text" id="name" name="invoice no">
          ...
          <input type="text" id="a" name="total_fraight" value="0">

          <label for="name">Advance:</label>
          <input type="text" id="b" name="advance" placeholder="cost" value="0">

          <label for="name">Balance:</label>
          <input type="text" id="x" name="balance"  placeholder="cost" value="0">

          <label for="name">W-Charge:</label>
